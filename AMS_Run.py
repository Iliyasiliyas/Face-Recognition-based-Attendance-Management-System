...
window = tk.Tk ()
window.title ( "FAMS-Face Recognition Based Attendance Management System by Mohammed Iliyas" )
window.geometry ( '1280x720' )
window.configure ( background='#355C7D' )
...
def fill_attendance() :
    ...
    if subb == '':
            ...
            def create_csv():
                ...
                csv_name = '"D:\project\face\Face-Recognition-Attendance-System\Attendance\Manually Attendance'+DB_table_name+'.csv'
